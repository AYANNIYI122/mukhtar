...
if (isset($_POST['submit'])) {
    ...
    if (!$title) {
        ...
        $_SESSION['edit-post'] = "could not update post. Invalid for data on edit post page";
    } elseif (!$body) {
        $_SESSION['edit-post'] = "could not update post. Invalid for data on edit post page";
    } else {
    ...
    if ($_SESSION['edit-post']) {
        ...
        if ($is_featured == 1) {
            $zero_all_is_featured_query = "UPDATE posts GET is_featured=0";
    ...
    if (mysqli_errno($connection)) {
        $_SESSION['edit-post'] = "couldn'nt update post";
